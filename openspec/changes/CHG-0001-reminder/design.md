...
- При успешной отправке уведомления всплывающее сообщение не показывается

### AddReminderDialog
- Фиксированный размер окна: 550x680 пикселей (без скроллирования)
- Поля: Title (Entry), Description (Text), DateTime (с календарём)
- Отображение выбранной даты: Label слева от выбора времени, обновляется при выборе даты в календаре, нажатии "Сегодня" или быстрого времени
- Быстрые кнопки: +1 мин, +15 мин, +30 мин, +1 час, +3 часа, +1 день
